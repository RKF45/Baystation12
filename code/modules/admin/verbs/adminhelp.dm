...
/client/verb/adminhelp(msg as text)
	...
	**/
	...
	if(admin_number_present <= 0)
		if(!admin_number_afk)
			send2adminirc("ADMINHELP from [src.key]: [original_msg] - No admins online")
		else
			send2adminirc("ADMINHELP from [src.key]: [original_msg] - All admins AFK")
	else
		send2adminirc("ADMINHELP from [src.key]: [original_msg]")
